...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    run = wandb.init(job_type="yolov9_training")
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if RANK in {-1, 0}:
            ...
            if (not nosave) or (final_epoch and not evolve):  # if save
                ...
                if best_fitness == fi:
                    #mlflow.pytorch.save_model(best, "yolov9_model_dir/yolov9")
                ...
                artifact = wandb.Artifact(name = opt.output_artifact, type="model_export", description="yolov9 model")
                artifact.add_dir("yolov9_model_dir/yolov9")
...
def parse_opt(known=False):
    ...
    parser.add_argument('--project', default=ROOT / 'yolov9_model_dir/yolov9', help='save to project/name')
    ...
    parser.add_argument('--output_artifact', type=str,  help='Version of wandb artifact to use')
